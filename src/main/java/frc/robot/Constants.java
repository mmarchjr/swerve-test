...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kBackLeftChassisAngularOffset = Units.degreesToRadians(90);
    public static final double kBackRightChassisAngularOffset = Units.degreesToRadians(180);
